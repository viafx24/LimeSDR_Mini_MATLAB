%
% Simple example how to transmit and receive signals simultaneously using LimeSDR_Mini
%
...
% (2) I changed the carrier frequency to 868e6 Hz
% (2) I CHANGED THE dev.rx0.antenna TO 3 (LNA_W) VERY IMPORTANT
...
dev.rx0.gain        = RxGain;
dev.rx0.antenna     = 3;     % LNA_W VERY IMPORTANT: 3 and not 2
