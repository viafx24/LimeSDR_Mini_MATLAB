%
% Simple example how to receive signal using LimeSDR_Mini
% Author: viafx24, Jan 2020
% Modified from Author:
%    Damir Rakhimov, CRL, TU Ilmenau, Dec 2019

% the main modification are:
% (1) I commented the addpath line below
% (2) I changed the carrier frequency to 100e6
% (3) I changed the sampling frequency to 1e6
% (4) I changed the gain to 40
% (5) I CHANGED THE dev.rx0.antenna TO 3 (LNA_W) VERY IMPORTANT
% BECAUSE LNA_L DOESN'T WORK WITH THE LIMESDR MINI
...
dev.rx0.gain        = Gain;
dev.rx0.antenna     = 3;     % LNA_W VERY IMPORTANT: 3 and NOT previous 2
